                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="p-price first-row">Rp 60.00</td>
                        ...
                        <div class="col-lg-12">
                            <div class="proceed-checkout text-left">
                                <ul>
                                    ...
                                    <li class="subtotal mt-3">Subtotal <span>Rp 240.00</span></li>
                                    <li class="subtotal mt-3">PPN <span>10%</span></li>
                                    <li class="subtotal mt-3">Total Biaya <span>Rp 264.00</span></li>
                                    <li class="subtotal mt-3">Bank Transfer <span>Bank Syariah Indonesia</span></li>
...
<script>
import HeaderShafiyya from '@/components/HeaderShafiyya.vue'
